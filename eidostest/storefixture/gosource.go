...
const projectedBody = `panic("storefixture: GoSource projects shape, not behaviour")`
...
const sourceHeader = "// Projected from a storefixture builder by Builder.GoSource.\n" +
...
func (e *UnspellableError) Error() string {
	return fmt.Sprintf("storefixture: GoSource cannot spell %s in %s; "+
