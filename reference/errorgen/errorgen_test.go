...
// the errorgen plugin: [plugintest.RunSuite] for the stability, role and
...
func TestConformance(t *testing.T) {
	...
	t.Run("framework contracts", func(t *testing.T) {
		t.Parallel()
		plugintest.RunSuite(t, errorgen.New())
	})

	t.Run("generator contracts", func(t *testing.T) {
		t.Parallel()
		plugintest.RunGeneratorSuite(t, errorgen.New(), []plugintest.GeneratorFixture{
			{
				Name: "empty store",
