...
// the tracegen plugin: [plugintest.RunSuite] for the stability, role and
...
func TestConformance(t *testing.T) {
	...
	t.Run("framework contracts", func(t *testing.T) {
		t.Parallel()
		plugintest.RunSuite(t, tracegen.New())
	})

	t.Run("generator contracts", func(t *testing.T) {
		t.Parallel()
		plugintest.RunGeneratorSuite(t, tracegen.New(), []plugintest.GeneratorFixture{
			{
				Name: "empty store",
