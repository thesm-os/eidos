...
// the metricgen plugin: [plugintest.RunSuite] for the stability, role and
...
func TestConformance(t *testing.T) {
	...
	t.Run("framework contracts", func(t *testing.T) {
		t.Parallel()
		plugintest.RunSuite(t, metricgen.New())
	})

	t.Run("generator contracts", func(t *testing.T) {
		t.Parallel()
		plugintest.RunGeneratorSuite(t, metricgen.New(), []plugintest.GeneratorFixture{
			{
				Name: "empty store",
