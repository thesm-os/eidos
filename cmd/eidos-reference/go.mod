...
require (
	...
	go.thesmos.sh/eidos/bridge/protogo v1.6.1
	go.thesmos.sh/eidos/cli v1.7.3
	go.thesmos.sh/eidos/frontend/golang v1.7.2
	go.thesmos.sh/eidos/frontend/protobuf v1.5.6
	go.thesmos.sh/eidos/plugins v1.10.0
	go.thesmos.sh/eidos/reference v1.8.0
)
